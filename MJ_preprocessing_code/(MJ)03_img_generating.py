...
def file_to_array(path, n=100000):
...
if __name__ == '__main__':
    ...
    save_to_dir = 'C:/dev/final_project/python_code/image_preporcessing/converted/'
    ...
    for name in file_list:
        ...
        i = 0
        for _ in train_datagen.flow(x, save_to_dir=save_to_dir, save_prefix=name.split('.')[0]+'_gen', save_format='jpg'):
            i += 1
            if i >= 10:
                break

    x = np.array([0,1,2,3,4])
    np.save('C:/dev/final_project/python_code/image_preporcessing/x_save', x)   # x_save.npy
    x_save_load = np.load('C:/dev/final_project/python_code/image_preporcessing/x_save.npy')
    print(x_save_load)
